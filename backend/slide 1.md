...
3 projects:
1. Lead Insights & Ticket Intelligence
2. AI Accessibility Navigation Assistant for SimNet
3. Developer Ai Assistant for Etech Integration Team
...
- **Ticket Intelligence**: A Freshdesk analytics and data ingestion workflow enabling natural language conversations with support ticket data. (RAG)
...
- **Enterprise-Ready AI Integration**: Unified text reasoning and vector embedding through **AWS Bedrock** (Claude 4.5 Haiku), shifting away from local models for better performance and scale.
